...
Two-Stage Retrieval (Advanced RAG):
Stage 1: Dense passage retrieval utilizing all-MiniLM-L6-v2 embeddings and ChromaDB to extract a broad set of candidate document chunks.
